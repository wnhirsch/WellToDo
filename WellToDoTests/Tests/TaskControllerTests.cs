...
public class TaskControllerTests
{
    ...
    public void GetTasks_ReturnsTasks()
    {
        ...
        // Act
        var result = _controller.GetTasks(userName, request, page, pageSize);
    ...
    [Test]
    public void CreateTask_ValidData_ReturnsNoContent()
    {
        // Arrange
        var userName = "john";
        ...
        // Act
        var result = _controller.CreateTask(userName, newTask);
    ...
    public void UpdateTask_ValidData_ReturnsOk()
    {
        ...
        // Act
        var result = _controller.UpdateTask(userName, taskId, editedTask);
        var okResult = result.Result as OkObjectResult;
    ...
    public void DeleteTask_ExistingTask_ReturnsNoContent()
    {
        ...
        // Act
        var result = _controller.DeleteTask(userName, taskId);
