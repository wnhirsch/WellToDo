...
public class GroupControllerTests
{
    ...
    public void GetGroups_ReturnsGroups()
    {
        ...
        // Act
        var result = _controller.GetGroups(userName);
        ...
        Assert.IsTrue(groups.All(group => group.UserId == 1));
    }

    [Test]
    public void CreateGroup_ReturnsNoContent()
    {
        // Arrange
        var userName = "john";
        ...
        // Act
        var result = _controller.CreateGroup(userName, newGroup);
    ...
    public void UpdateGroup_ExistingGroup_ReturnsOk()
    {
        ...
        // Act
        var result = _controller.UpdateGroup(userName, groupId, editedGroup);
        var okResult = result.Result as OkObjectResult;
    ...
    public void DeleteGroup_ExistingGroup_ReturnsNoContent()
    {
        ...
        // Act
        var result = _controller.DeleteGroup(userName, groupId);
